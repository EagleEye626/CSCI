...
while num_of_incorrect_guesses < TOTAL_NUM_OF_INCORRECT_GUESSES_ALLOWED and False in guessed_answer:
  ...
  for current_guesssed_letter in guessed_letters:
    print(f"{current_guesssed_letter} ", end = "")

  print()

  print(f"num_of_incorrect_remaining: {TOTAL_NUM_OF_INCORRECT_GUESSES_ALLOWED - num_of_incorrect_guesses}")
...
if num_of_incorrect_guesses < TOTAL_NUM_OF_INCORRECT_GUESSES_ALLOWED:
  print("Congradulations, you solved the Puzzle!")
else:
